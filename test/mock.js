...
module.exports = [
    ...
    },
    {
        ...
        handle: function (req, res, next) {
            ...
            res.end(JSON.stringify(
                {
                    company:{name:'瓦力科技',address:'南岗区嵩山路19号',type:{name:"软件",id:'k1'},police:{name:'林琳',id:'p1'},groupType:0,fireState:0,legalPersonName:'张三',legalPersonCard:'230105199605223629'},
